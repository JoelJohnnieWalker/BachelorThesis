...
for sector, companies in sectors.items():
    for company in companies:
        ...
        for index, row in data[company].iterrows():
            if (row.CDLGRAVESTONEDOJI == 100) and (data[company].iloc[index-1]['Trend'] == 0):
...
df_postivie_negative1['Positive Trades Portion'] = df_postivie_negative1['Positive Trades'] / df_postivie_negative1['Total Trades']
...
path = r'Analysis/RowData/Gravestone-bullish-1-PosNeg.csv'
...
path = r'Analysis/RowData/Gravestone-bullish-1-MeanProfits.csv'
...
print(df_Profits1)
path = r'Analysis/RowData/Gravestone-bullish-1-Profits.csv'
...
df_postivie_negative3['Positive Trades Portion'] = df_postivie_negative3['Positive Trades'] / df_postivie_negative3['Total Trades']
df_postivie_negative3 = df_postivie_negative3.transpose()
print("\nPostitive / Negative after 3 Days\n")
print(df_postivie_negative3)
 # Save the dataframe as a CSV pfile
path = r'Analysis/RowData/Gravestone-bullish-3-PosNeg.csv'
...
path = r'Analysis/RowData/Gravestone-bullish-3-MeanProfits.csv'
...
print(df_Profits3)
path = r'Analysis/RowData/Gravestone-bullish-3-Profits.csv'
...
df_postivie_negative5['Positive Trades Portion'] = df_postivie_negative5['Positive Trades'] / df_postivie_negative5['Total Trades']
df_postivie_negative5 = df_postivie_negative5.transpose()
print("\nPostitive / Negative after 5 Days\n")
print(df_postivie_negative5)
 # Save the dataframe as a CSV pfile
path = r'Analysis/RowData/Gravestone-bullish-5-PosNeg.csv'
...
path = r'Analysis/RowData/Gravestone-bullish-5-MeanProfits.csv'
...
print(df_Profits5)
path = r'Analysis/RowData/Gravestone-bullish-5-Profits.csv'
...
df_postivie_negative7['Positive Trades Portion'] = df_postivie_negative7['Positive Trades'] / df_postivie_negative7['Total Trades']
df_postivie_negative7 = df_postivie_negative7.transpose()
print("\nPostitive / Negative after 7 Days\n")
print(df_postivie_negative7)
 # Save the dataframe as a CSV pfile
path = r'Analysis/RowData/Gravestone-bullish-7-PosNeg.csv'
...
path = r'Analysis/RowData/Gravestone-bullish-7-MeanProfits.csv'
...
print(df_Profits7)
path = r'Analysis/RowData/Gravestone-bullish-7-Profits.csv'
...
df_postivie_negative10['Positive Trades Portion'] = df_postivie_negative10['Positive Trades'] / df_postivie_negative10['Total Trades']
df_postivie_negative10 = df_postivie_negative10.transpose()
print("\nPostitive / Negative after 10 Days\n")
print(df_postivie_negative10)
 # Save the dataframe as a CSV pfile
path = r'Analysis/RowData/Gravestone-bullish-10-PosNeg.csv'
...
path = r'Analysis/RowData/Gravestone-bullish-10-MeanProfits.csv'
...
print(df_Profits10)
path = r'Analysis/RowData/Gravestone-bullish-10-Profits.csv'
