...
for sector, companies in sectors.items():
    for company in companies:
        ...
        for index, row in data[company].iterrows():
            if (row.CDLMATCHINGLOW == 100) and (data[company].iloc[index-2]['Trend'] == 0):
...
path = r'Analysis/RowData/Matching-Low-1-PosNeg.csv'
...
path = r'Analysis/RowData/Matching-Low-1-MeanProfits.csv'
...
print(df_Profits1)
path = r'Analysis/RowData/Matching-Low-1-Profits.csv'
...
print(df_postivie_negative3)
 # Save the dataframe as a CSV pfile
path = r'Analysis/RowData/Matching-Low-3-PosNeg.csv'
...
path = r'Analysis/RowData/Matching-Low-3-MeanProfits.csv'
...
print(df_Profits3)
path = r'Analysis/RowData/Matching-Low-3-Profits.csv'
...
print(df_postivie_negative5)
 # Save the dataframe as a CSV pfile
path = r'Analysis/RowData/Matching-Low-5-PosNeg.csv'
...
path = r'Analysis/RowData/Matching-Low-5-MeanProfits.csv'
...
print(df_Profits5)
path = r'Analysis/RowData/Matching-Low-5-Profits.csv'
...
print(df_postivie_negative7)
 # Save the dataframe as a CSV pfile
path = r'Analysis/RowData/Matching-Low-7-PosNeg.csv'
...
path = r'Analysis/RowData/Matching-Low-7-MeanProfits.csv'
...
print(df_Profits7)
path = r'Analysis/RowData/Matching-Low-7-Profits.csv'
...
print(df_postivie_negative10)
 # Save the dataframe as a CSV pfile
path = r'Analysis/RowData/Matching-Low-10-PosNeg.csv'
...
path = r'Analysis/RowData/Matching-Low-10-MeanProfits.csv'
...
print(df_Profits10)
path = r'Analysis/RowData/Matching-Low-10-Profits.csv'
